            ...
            <div className="container px-48 mx-auto mt-12">
                <div className="flex flex-row w-full h-14 justify-between">
                    <div className="flex flex-row mt-2">
                        <button type="button" className={`w-32 font-bold rounded-t-normal-radius flex justify-center items-center gap-1
                                ${activeTab === 'admins' ? "bg-background underline" : "bg-white"}`}
                                onClick={() => setActivetab("admins")}
                        ><FaUser />ADMINS
                        </button>
                        <button type="button" className={`w-32 font-bold rounded-t-normal-radius flex justify-center items-center gap-1
                                ${activeTab === 'members' ? "bg-background underline" : "bg-white"}`}
                                onClick={() => setActivetab("members")}
                        ><FaUserCog />MEMBERS
                        </button>
                    </div>
                    <div className="flex flex-row items-center pr-2 mb-2">
                        <div className="scale-75"><SearchBar /></div>
                ...
                <div className="bg-background w-full py-3 rounded-tr-normal-radius rounded-b-normal-radius">
                    ...
                    <div className="divide-y">
                        <MemberItem email="crystal@gmail.com" createdAt="2024-06-17" nickname="^^" isAccountActive={true}
                            className="rounded-t-normal-radius"
                        />
                        <MemberItem email="crystal@gmail.com" createdAt="2024-06-17" nickname="^^" isAccountActive={true} />
                        <MemberItem email="crystal@gmail.com" createdAt="2024-06-17" nickname="^^" isAccountActive={false} />
                        <MemberItem email="crystal@gmail.com" createdAt="2024-06-17" nickname="^^" isAccountActive={false}
