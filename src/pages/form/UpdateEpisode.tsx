...
function UpdateEpisode({title, chapter, subtitle}: UpdateEpisodeProps): React.JSX.Element {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-20 flex justify-center items-center">
            <div className="flex flex-col gap-10 bg-white w-[800px] p-6 rounded-md shadow-lg">
                <div className="flex flex-row justify-between">
                    ...
                    <MainButton label="저장" className="w-14 mr-3 align-top self-start"/>
                </div>
                ...
                <div className="flex flex-row">
                    ...
                    <InputBox label="회차 제목" className="w-96" defaultValue={subtitle} />
                </div>
